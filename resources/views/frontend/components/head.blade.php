<title>Bootie Ecommerce Bootstrap Responsive Web Template | Home :: W3layouts</title>
    ...
    <!-- Custom-Files -->
    <link rel="stylesheet" href="{{asset('frontend-tas')}}/css/bootstrap.css">
    <!-- Bootstrap-Core-CSS -->
    <link rel="stylesheet" href="{{asset('frontend-tas')}}/css/style.css" type="text/css" media="all" />
    <!-- Style-CSS -->
    <!-- font-awesome-icons -->
    <link href="{{asset('frontend-tas')}}/css/font-awesome.css" rel="stylesheet">
    <!-- //font-awesome-icons -->
    <!-- /Fonts -->
