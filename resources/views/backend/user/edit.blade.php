        ...
        <div class="list_of_members">
            <div class="card shadow p-3 mb-5 bg-white rounded">
                <div class="card-header mb-5">
                    <h4 class="mb-5"><strong>Edit User</strong></h4>
                </div>
                <div class="card-body">
                    <form action="/user/update/{{ $user->id }}" method="post">
                        ...
                        <div style="margin: 20px 0;">
                            ...
                            <div>
                                ...
                                <input type="radio" name="role" id="role1" value="1" @checked($user->role == '1')>
                                Admin
                            </div>
                            <div>
                                <label for="role2" class="radio-inline"></label>
                                <input type="radio" name="role" id="role2" value="0" @checked($user->role == '0')>
                                Pelanggan
                            </div>
                        </div>
                        <div style="margin: 20px 0;">
                            <label for="address" style="margin-bottom: 5px">Address</label>
                            <textarea rows="5" name="address" id="address" class="form-control" placeholder="Input Address">{{ $user->address }}</textarea>
                         ...
                         <div style="margin: 20px 0;">
                            ...
                            <div>
                                ...
                                <input type="radio" name="role" id="gender1" value="Laki-laki" @checked($user->gender == 'Laki-laki')>
                                Laki-laki
                            </div>
                            <div>
                                <label for="gender2" class="radio-inline"></label>
                                <input type="radio" name="gender" id="gender2" value="Perempuan" @checked($user->gender == 'Perempuan')>
                                Perempuan
                            </div>
